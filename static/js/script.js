...
//                 this.style.backgroundColor = "#1d2d03ff";

//                 setTimeout(() => {
//                     this.textContent = "Add to cart";
//                     this.style.backgroundColor = "#558903";
//                 }, 1500);
//             }
//         })
...
// ── Mobile Sub-category accordion inside main accordion ──
document.querySelectorAll('.mob-subcat-btn').forEach(btn => {
