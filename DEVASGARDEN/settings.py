"""
Django settings for DEVASGARDEN project.
...
SECRET_KEY = 'django-insecure-re$(z33^x%xm3@abpt91rpf6@ux57aq(zk1l!9+&%^l9af^m6#'
...
WSGI_APPLICATION = 'DEVASGARDEN.wsgi.application'
